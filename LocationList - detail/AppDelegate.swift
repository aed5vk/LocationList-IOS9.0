...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    static let projectName = "LocationList - detail"
    
    static let dataModelName = "LocationList2.0"
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("LocationList2.0", withExtension: "momd")!
